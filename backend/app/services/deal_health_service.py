...
from app.models.subscription import Invoice, Subscription, SubscriptionStatus
...
class DealHealthService:
    ...
    async def get_dashboard_metrics(self) -> DashboardMetricsResponse:
        ...
        total_pipeline_value = round(pipeline_val_res.scalar_one(), 2)
        ...
        total_invoiced_revenue = round(inv_res.scalar_one(), 2)
