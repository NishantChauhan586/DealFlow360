...
const MOCK_NOTIFICATIONS = [
  { id: 'n1', text: 'Acme Corp deal moved to Won', time: '2m ago', unread: true },
  { id: 'n2', text: 'New proposal required for Greenleaf Holdings', time: '34m ago', unread: true },
  { id: 'n3', text: 'Follow-up reminder: Vertex Systems', time: '1h ago', unread: false },
];
