        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            {basePriceNum > 0 && (
              ...
              >
                Margin: {marginPct.toFixed(1)}% ({formatINR(grossProfit)})
              </span>
            )}
            <button
              onClick={onClose}
            ...
            {activeTab === 'basic' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '16px' }}>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '12.5px', fontWeight: 600, marginBottom: '6px' }}>
                      SKU (Stock Keeping Unit) <span style={{ color: 'var(--rose)' }}>*</span>
                    </label>
                    <input
                      type="text"
            ...
            {activeTab === 'pricing' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '12.5px', fontWeight: 600, marginBottom: '6px' }}>
                      Base Price (₹) <span style={{ color: 'var(--rose)' }}>*</span>
                    </label>
                    <input
                      type="number"
                      step="0.01"
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '12.5px', color: 'var(--ink-60)', marginTop: '2px' }}>
                      Gross Unit Profit: <span className="tnum">{formatINR(grossProfit)}</span> per {formData.unit}
                    </div>
                  </div>
