...
export default function Pipeline() {
  ...
  const handleCardClick = (d) => {
    const val = typeof d.grandTotal === 'number' ? d.grandTotal : (typeof d.grand_total === 'number' ? d.grand_total : null);
    navigate('/builder', {
      state: {
        customer: d.customer_name || d.company_name || d.cust,
        amt: val !== null ? `₹${val.toLocaleString('en-IN')}` : (d.amt || '₹0'),
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {dealsList.map((d, i) => {
              ...
              return (
                ...
                >
                  <div className="cust">{d.customer_name || d.company_name || d.cust || 'Unknown'}</div>
                  <div className="amt">
                    {val !== null 
                  ...
                  <div className="meta">
                    <span>{d.sales_rep || d.rep || 'System'}</span>
